...
import br.edu.infnet.appaventureiro.controller.FeiticoController;
...
public class FeiticoTeste implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		FeiticoController.incluir(feitico1);
		...
		FeiticoController.incluir(feitico2);
		...
		FeiticoController.incluir(feitico3);
	}
}
